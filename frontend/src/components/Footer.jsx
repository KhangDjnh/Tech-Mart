        ...
        <div>
            <footer className="footer p-10 bg-gray-800 text-white rounded">
                ...
                <nav className="flex justify-center space-x-8 mb-4">
                    ...
                    <a className="link link-hover text-gray-300 hover:text-white" href="#">Contact</a>
                    <a className="link link-hover text-gray-300 hover:text-white" href="#">Jobs</a>
                    <a className="link link-hover text-gray-300 hover:text-white" href="#">Press kit</a>
                </nav>
                {/* Social Icons */}
